    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_to_usa', models.PositiveIntegerField(default=0, help_text='Указывать в долларах', verbose_name='Сборы в США')),
                ('fees_to_world', models.PositiveIntegerField(default=0, help_text='Указывать в долларах', verbose_name='Сборы в Мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Черновик')),
                ('actors', models.ManyToManyField(related_name='actor', to='movie.actor', verbose_name='актеры')),
